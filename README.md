...
This is an MCP (Model Context Protocol) server that provides access to the Test Nikola 2 API. It enables AI agents and LLMs to interact with Test Nikola 2 through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with Test Nikola 2 endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **Test Nikola 2 Website**: [https://petstore.swagger.io/](https://petstore.swagger.io/)
- **API Documentation**: []()
...
*Note: Replace `example_tool` with actual Test Nikola 2 API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/test-nikola-2-mcp-server.git
   cd test-nikola-2-mcp-server
   ```
...
1. Create API client functions for Test Nikola 2 endpoints
...
```json
{
  "github_url": "https://github.com/Traia-IO/test-nikola-2-mcp-server",
  "mcp_server": {
    "name": "test-nikola-2-mcp",
    "description": "This is test purpose mcp server",
